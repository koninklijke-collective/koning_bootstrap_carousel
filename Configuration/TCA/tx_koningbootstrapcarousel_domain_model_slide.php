...
return array(
    ...
    'interface' => array(
        'showRecordFieldList' => 'hidden, title, link, link_text, slider_text, visual, visual_size, visual_position'
    ),
    'types' => array(
        0 => array(
            'showitem' => 'title;;access, link, link_text, slider_text, visual, visual_size, visual_position'
        )
    ),
    'palettes' => array(
        'access' => array(
    ...
    'columns' => array(
        ...
        'slider_text' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:koning_bootstrap_carousel/Resources/Private/Language/locallang_be.xlf:tx_koningbootstrapcarousel_domain_model_slide.slider_text',
            'config' => array(
                'type' => 'text',
                'eval' => 'trim',
                'cols' => 30,
